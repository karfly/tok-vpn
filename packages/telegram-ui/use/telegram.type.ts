...
type PopupCloseCallback = (id: string) => void;

type AlertCloseCallback = () => void;
...
type BackButton = {
  ...
  onClick: (callback: Fn) => void;

  offClick: (callback: Fn) => void;
...
export interface TelegramWebApp {
   ...
   */
  onEvent(eventType: EventType, eventHandler: Fn): void;
  /**
   * 	A method that deletes a previously set event handler.
   */
  offEvent(eventType: EventType, eventHandler: Fn): void;
  /**
  ...
  showPopup(params: PopupParams, callback: PopupCloseCallback): void;

  showAlert(message: string): void;
  showAlert(message: string, callback: AlertCloseCallback): void;
}
...
interface MainButton {
   ...
   */
  onClick(callback: Fn): MainButton;

  offClick(callback: Fn): MainButton;
  /**
